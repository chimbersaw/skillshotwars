...
function Precache(context)
    ...
    PrecacheItemByNameSync("item_glimmer_cape_skillshot", context)
    PrecacheItemByNameSync("item_manta_skillshot", context)
    PrecacheItemByNameSync("item_refresher_skillshot", context)
    PrecacheItemByNameSync("item_bloodstone_skillshot", context)
    PrecacheItemByNameSync("item_kaya_skillshot", context)
    PrecacheItemByNameSync("item_octarine_core_skillshot", context)
